                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gender" type="text" class=" @error('gender') is-invalid @enderror" name="gender" value="{{ old('gender') }}" required autocomplete="gender">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="membership" type="text" class=" @error('membership') is-invalid @enderror" name="membership" value="{{ old('membership') }}" required autocomplete="membership">
